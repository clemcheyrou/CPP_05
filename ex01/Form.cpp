...
/*   Updated: 2023/07/12 16:36:18 by ccheyrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << GREEN "Constructor Form" CLOSE " called" << std::endl;
	return ;
}
...
Form::Form( Form const &copy ) : _name(copy._name), _grade_signed(copy._grade_signed), _grade_exec(copy._grade_exec)
{
...
Form::~Form()
{
	std::cout << RED "Destructor Form" CLOSE " called" << std::endl;	
	return;
}
